	...
	theme: {
		...
		extend: {
			colors: {
				...
				attendance: {
					excellent: 'hsl(var(--attendance-excellent))',
					good: 'hsl(var(--attendance-good))',
					average: 'hsl(var(--attendance-average))',
					poor: 'hsl(var(--attendance-poor))',
				},
				sidebar: {
			...
			fontSize: {
				...
				'display-md': ['2.875rem', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
